...
#line 34 "./src/calc.y"
                                        { printf("%f\n", (yyvsp[0].num)); }
#line 1094 "./src/y.tab.c"
    break;

  case 5: /* statement: ID '=' expression  */
#line 35 "./src/calc.y"
                                  { 
            //save_lexcomp($1.str,ID,$3);
             //printf("COSA: %s\n",$1);
        }
#line 1103 "./src/y.tab.c"
    break;

  case 7: /* expression: ID  */
#line 42 "./src/calc.y"
                                       {
            (yyval.num)=3.0f;
        }
...
#line 46 "./src/calc.y"
                                        { (yyval.num) = (yyvsp[-2].num) - (yyvsp[0].num); }
#line 1123 "./src/y.tab.c"
    break;

  case 10: /* expression: expression '*' expression  */
#line 47 "./src/calc.y"
                                        { (yyval.num) = (yyvsp[-2].num) * (yyvsp[0].num); }
#line 1129 "./src/y.tab.c"
    break;
